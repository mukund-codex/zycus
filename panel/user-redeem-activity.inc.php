            ...
            <table width="540" border="0" cellspacing="0" cellpadding="20" bgcolor="#ffffff" class="100p">
                <tr>
                    <td align="center" style="font-size:16px; color:#848484;"><font face="'Roboto', Arial, sans-serif">
                        ...
                        <span style="font-size:14px;">Your request for the Redeem Activity has been considered, will update soon.</span><br/><br/>
                        ...
                        <table width="500" border="0" cellspacing="0" cellpadding="20" bgcolor="#ffffff" class="100p">
                            ...
                            <tbody>
                                <tr>
                                    <td style="text-align:center;"><?php echo $rewardDetails['reward_name']; ?></td>
                                    <td style="text-align:center;"><?php echo $rewardDetails['points']; ?></td>
                                </tr>
                            </tbody>
