<?php 
	...
	$pageURL = 'disapprove-redeem1.php';
	...
	if(isset($_POST['register'])){
		...
		$query = $func->query("update ".PREFIX."redeem_activity set approved = '".$approved."', approved_by = '".$approvedby."', approved_time = '".$approved_time."', rejected_reason = '".$reason."' where id = '".$id."' ");
