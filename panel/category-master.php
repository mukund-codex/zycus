	...
	<div class="page-container">
		...
		?>
 		...
 		<div class="page-content">
			...
			<a href="<?php echo $addURL; ?>" class="label label-primary">Add Category</a><br/><br/>
							...
							<tr class="orders">
								...
								<td>
									<form action="" method="post" id="orderForm" style="display:block;">
										...
										<input type="text" name="display_order" id="display_order" class="form-control display" value="<?php echo $row['display_order']; ?>" style="width:20%;">
									</form>
								</td>
								<td><?php if($row['active'] == '1'){   
									echo '<a href="changeCategoryActiveStatus.php?edit&id='.$row['id'].'" name="active_status" onclick="return confirm(\'Are you sure you want to Inactivate this Category ?\');" ><span class="label label-success">Yes</span></a>';
								}else{ 
									echo '<a href="changeCategoryActiveStatus.php?edit&id='.$row['id'].'" name="active_status" onclick="return confirm(\'Are you sure you want to Activate this Category ?\');" ><span class="label label-danger">No</span></a>'; 
								} ?></td>	
								<td><?php echo $newDate = date('d-F-Y H:i:s A', strtotime($row['created'])); ?></td>					
								<td>
								
									<a href="<?php echo $addURL; ?>?edit&id=<?php echo $row['id'] ?>" name="edit"  title="Click to edit this row">Edit</a>
...
<?php 	include "include/footer.php"; ?>
	...
	<script>
		$(".display").on("keyup",function(){
			...
			$.ajax({
				type: "POST",
				url: "ajaxChangeCategoryOrder.inc.php",
