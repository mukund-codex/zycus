<?php
	...
	if(isset($_POST['register'])){
		...
		$activityDetails = $func->getUniqueActivityById($_POST['activity']);
        ...
        $func->addActivityUser($_POST);
        header("location: user-activity.php?registersuccess");
	}
	if(isset($_GET['edit'])){
		$id = $func->escape_string($func->strip_all($_GET['id']));
        $data = $func->getUserById($id);
    }
    
    if(isset($_POST['update'])){
        $func->updateActivityUser($_POST);
        header("location: user-activity.php?updatesuccess");
    }   
						...
						<div class="form-group">
							<div class="row">
								<div class="col-sm-3">
									...
									<select class="select-multiple" name="email" id="email" required>
								...
								<div class="col-sm-3">
									...
									<select class="select-multiple" name="category" id="category" required onchange="getDetails();">
										<option value="">Select</option>
										<?php
								...
								<div class="col-sm-3">
									...
									<select class="select-multiple" name="activity" id="activity" required>
									</select>
								</div>
								<div class="col-sm-3">
									<label>Status <span style="color:red">*</span></label>
									<select class="select-multiple" name="status" id="status" required>
										<option value="">Select</option>
								...
								<!-- <div class="col-sm-3">
									...
									<select class="select-multiple" name="points" id="points" required>
									</select>
								</div>                     -->
							</div>
                            <!-- <br> -->
...
<?php 	include "include/footer.php"; ?>
	...
	function getDetails(){
		...
		$.ajax({
		    type: "POST",
		    url: "getDetailsbyCategory.inc.php",
