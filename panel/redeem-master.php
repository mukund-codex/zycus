<?php
    ...
    $pageName = "Redeem Master";
    $addURL = 'add-redeem.php';
    $deleteURL = 'delete-redeem.php';
	$tableName = 'redeem_master';
	...
	$sql = "SELECT * FROM ".PREFIX.$tableName." where isdelete != '1' order by display_order ASC";
	...
	<div class="page-container">
		...
		<?php include 'include/sidebar.php' ?>
 		...
 		<div class="page-content">
			...
			<a href="<?php echo $addURL; ?>" class="label label-primary">Add Reward Details</a><br/><br/>
...
<?php
						...
						while($row = $func->fetch($results)){ 
							$category = $func->fetch($func->query("select category_name from ".PREFIX."category_master where id = '".$row['category']."' "));
?>
							<tr class="orders">
								<td><?php echo $x++; ?></td>
								...
								<td><?php if($row['active'] == '1'){  
									echo '<a href="changeRedeemActiveStatus.php?edit&id='.$row['id'].'" name="active_status" onclick="return confirm(\'Are you sure you want to Inactivate this Reward ?\');" ><span class="label label-success">Yes</span></a>';
								}else{ 
									echo '<a href="changeRedeemActiveStatus.php?edit&id='.$row['id'].'" name="active_status" onclick="return confirm(\'Are you sure you want to Activate this Reward ?\');" ><span class="label label-danger">No</span></a>'; 
								} ?></td>
	...
	<script>
		$(document).ready(function() {
			...
			$(".display").on("keyup",function(){
				...
				$.ajax({
					type: "POST",
					url: "ajaxChangeRedeemOrder.inc.php",
