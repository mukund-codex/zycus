<?php 
	...
	if(isset($_POST['submit'])){ 
		...
		include('user-interested-mail.inc.php');
...
<body>
	...
	<form method="post" id="myform" class="already-done-fm">
		...
		<div class="form-group">
			<textarea type="text" name="remark" class="form-control" required rows="4" placeholder="Please share details on the activity and the Zycus Contact you engaged with."></textarea>
		</div>
		<div class="form-group">
			<input type="hidden" name="userid" id="userid" value="<?php echo $loggedInUserDetailsArr['id']; ?>" />
			<input type="hidden" name="status" id="status" value="interested" />
