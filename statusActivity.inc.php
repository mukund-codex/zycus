<?php
    ...
    if(isset($_POST['status']) && !empty($_POST['status'])){
        ...
        if($status == "all"){  
            ...
            $query = $func->query("select * from ".PREFIX."user_activity where userid = '".$loggedInUserDetailsArr['id']."' and status = '".$status."' and approved = 'Approved' ".$wherecondition." ".$sort." ");            
        ...
        if($detail == ''){
            $detail = " Sorry, currently there are no activities under this category.";
        }
