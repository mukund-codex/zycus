		            ...
		            <div class="collapse navbar-collapse" id="myNavbar">
		                <ul class="nav navbar-nav menus navbar-right">
							...
							<?php }else{ ?>
								...
								<!-- <li class="dropdown">
									<a class="dropdown-toggle sb-nav" data-toggle="dropdown"><?php echo $loggedInUserDetailsArr['fname']; ?>
									<span class="">
									<img src="images/d-ar.png" id="sbnav-open">
									<img src="images/u-ar.png" style="display:none;" id="sbnav-close" >
									</span></a>
