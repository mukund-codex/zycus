<?php 
	...
	class SaveImage{
		...
		function uploadFileFromForm($sourceFileElement, $dir, $targetFileName = '', $allowedExt = ''){
			...
			$allowedExt = (empty($allowedExt)) ? array('image/jpeg','image/jpg', 'image/png', 'image/gif', 'application/pdf','application/zip','application/x-zip-compressed','application/x-zip', 'application/msword',
